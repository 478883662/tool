...
public class BaseDao {
     ...
     */
    public static <T> int insert(T t) throws SQLException, BizException {
        if (t == null || !t.getClass().isAnnotationPresent(DbTableAnnotation.class)) {
            throw new BizException("未被DbTableAnnotation注解的类");
        }
     ...
     * @throws IllegalAccessException
     */
    public static <T> int update(T setT, T whereT) throws SQLException, BizException {
     ...
     * @throws IllegalAccessException
     */
    public static <T> int updateForValue(T setT, T whereT) throws SQLException, BizException {
        if (setT == null || !setT.getClass().isAnnotationPresent(DbTableAnnotation.class)) {
            throw new BizException("未被DbTableAnnotation注解的类");
        }
        //获取表名
     ...
     * @throws IllegalAccessException
     */
    public static <T> int count(T t) throws SQLException, BizException {
        if (t == null || !t.getClass().isAnnotationPresent(DbTableAnnotation.class)) {
            throw new BizException("未被DbTableAnnotation注解的类");
        }
        String tableName = AnnotationUtil.getAnnotationValue(t.getClass(), DbTableAnnotation.class);
     ...
     * @throws IllegalAccessException
     */
    public static <R, T> List<R> select(T t, Class<R> clazz) throws SQLException, BizException {
        if (t == null || !t.getClass().isAnnotationPresent(DbTableAnnotation.class)) {
            throw new BizException("未被DbTableAnnotation注解的类");
        }
        String tableName = AnnotationUtil.getAnnotationValue(t.getClass(), DbTableAnnotation.class);
     ...
     * @throws IllegalAccessException
     */
    public static <T> int delete(T t) throws SQLException, BizException {
        if (t == null || !t.getClass().isAnnotationPresent(DbTableAnnotation.class)) {
            throw new BizException("未被DbTableAnnotation注解的类");
        }
        String tableName = AnnotationUtil.getAnnotationValue(t.getClass(), DbTableAnnotation.class);
