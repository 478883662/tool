...
public class ReimRemoteGetUserByYlCardStrategy extends ICxnhRemoteAdapter{
    ...
    @Override
    public  List<ReimbUserInfoPO> parse(String result){
        List<ReimbUserInfoPO> reimbUserInfoPOList = new ArrayList<>();
        ...
        for (String row:rowList){
            ...
            reimbUserInfoPO.setCardNo(resultList[0]);
            reimbUserInfoPO.setYlCard(resultList[1]);
            reimbUserInfoPO.setMasterName(resultList[2]);
            reimbUserInfoPO.setSufId(resultList[3]);
            reimbUserInfoPO.setSeq(resultList[4]);
            reimbUserInfoPO.setReleationNum(resultList[5]);
            reimbUserInfoPO.setName(resultList[6]);
            reimbUserInfoPO.setSex(resultList[7]);
            reimbUserInfoPO.setBirthday(resultList[8]);
            reimbUserInfoPO.setIdCard(resultList[9]);
            reimbUserInfoPO.setAge(resultList[10]);
            reimbUserInfoPO.setSelfNo(resultList[11]);
            reimbUserInfoPO.setPreId(resultList[17]);
            reimbUserInfoPO.setFamilyLocation(StrUtil.replace(resultList[12],"-","")
                    .replace("&gt;",""));
            reimbUserInfoPOList.add(reimbUserInfoPO);
        }
        return reimbUserInfoPOList;
    }
}
