...
import com.zhangb.family.doctor.operate.bo.ReimbPrintBo;
...
import com.zhangb.family.doctor.common.util.PrintBizUtil;
...
//        downloadImg(chuFangImgFileName, reimbDealRecord.getIdCard());
        ...
        reimbPrintInfoPO.setBizId(reimbDealRecord.getBizId());
        reimbPrintInfoPO.setPrintState("1002");
        reimbService.savePrintInfo(reimbPrintInfoPO);
    }
